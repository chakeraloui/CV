...
task CollectQualityYieldMetrics {
  ...
  command {
    java -Xms2000m -jar /home/aloui/chaker/WD/tools/picard.jar   \
...
task CollectUnsortedReadgroupBamQualityMetrics {
  ...
  command {
    java -Xms5000m -Xmx5000m -jar /home/aloui/chaker/WD/tools/picard.jar   \
    ...
    touch  ~{output_bam_prefix}.base_distribution_by_cycle.pdf \
           ~{output_bam_prefix}.base_distribution_by_cycle_metrics \
           ~{output_bam_prefix}.insert_size_histogram.pdf \
           ~{output_bam_prefix}.insert_size_metrics \
           ~{output_bam_prefix}.quality_by_cycle.pdf \
           ~{output_bam_prefix}.quality_by_cycle_metrics \
           ~{output_bam_prefix}.quality_distribution.pdf \
           ~{output_bam_prefix}.quality_distribution_metrics
...
task CollectReadgroupBamQualityMetrics {
  ...
  command {
    ...
    java -Xms4000m  -Xmx5000m -jar /home/aloui/chaker/WD/tools/picard.jar  \
      CollectMultipleMetrics \
      INPUT=~{input_bam} \
...
task CollectAggregationMetrics {
  ...
  command {
    ...
    java -Xms5000m -Xms5000m -jar /home/aloui/chaker/WD/tools/picard.jar   \
      CollectMultipleMetrics \
      INPUT=~{input_bam} \
      REFERENCE_SEQUENCE=~{ref_fasta} \
      OUTPUT=~{output_bam_prefix} \
...
task ConvertSequencingArtifactToOxoG {
  ...
  command {
      ...
      java -Xms4g  -Xmx5g -Dpicard.useLegacyParser=false \
        -jar /home/aloui/chaker/WD/tools/picard.jar  \
...
task CrossCheckFingerprints {
  ...
  command <<<
    java -Dsamjdk.buffer_size=131072 \
      -XX:GCTimeLimit=50 -XX:GCHeapFreeLimit=10 -Xms2000m -Xms4000m\
      -jar /home/aloui/chaker/WD/tools/picard.jar  \
...
task CheckFingerprint {
  ...
  command <<<
    java -Dsamjdk.buffer_size=131072 \
      -XX:GCTimeLimit=50 -XX:GCHeapFreeLimit=10 -Xms2g -Xms5g \
      -jar /home/aloui/chaker/WD/tools/picard.jar  \
      CheckFingerprint \
      INPUT=~{input_bam} \
...
task ValidateSamFile {
  ...
  command {
    java -Xms4g  -Xmx5g -jar /home/aloui/chaker/WD/tools/picard.jar  \
      ValidateSamFile \
      INPUT=~{input_bam} \
...
task CollectWgsMetrics {
  ...
  command {
    java -Xms2000m -Xms5000m -jar /home/aloui/chaker/WD/tools/picard.jar  \
      CollectWgsMetrics \
      INPUT=~{input_bam} \
...
task CalculateReadGroupChecksum {
  ...
  command {
    java -Xms1000m -jar /home/aloui/chaker/WD/tools/picard.jar  \
...
task ValidateVCF {
  ...
  command {
    gatk --java-options -Xms4000m -Xms5000m \
      ValidateVariants \
      -V ~{input_vcf} \
      -R ~{ref_fasta} \
